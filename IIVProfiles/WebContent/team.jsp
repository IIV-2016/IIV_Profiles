...
<body>
		...
		<div class="container content">
			...
			<div class="row portfolio-item">
				<section id="<%=team.getName()%>">
					<div class="heading heading-v1">
						<a
							href="<%=request.getContextPath()%>/volunteer.do?command=teamDetail&teamNumber=<%=team.getNumber()%>"><h2><%=team.getName()%>
								<i class="fa fa-angle-right" style="color: #72c02c;"></i><i
									class="fa fa-angle-right" style="color: #72c02c;"></i>
							</h2></a>
					</div>
				</section>
			</div>
			<div class="owl-carousel-v1 owl-work-v1">
				...
				<div class="owl-recent-works-v1">
					...
					<div class="item">
						<a
							href="<%=request.getContextPath()%>/volunteer.do?command=member&memberNumber=<%=volunteer.getNumber()%>">
							<em class="overflow-hidden"> <img class="img-responsive"
								src="<%=volunteer.getImage()%>"
								alt="<%=volunteer.getFirstname()%><%=volunteer.getLastname()%>"></em>
	...
	<script type="text/javascript"
		src="assets/js/plugins/owl-recent-works.js"></script>
	<script type="text/javascript">
